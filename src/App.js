...
const ListBlogPage = React.lazy(() => import("pages/ListBlogPage"));
...
const UserPost = React.lazy(() => import("pages/UserPost"));
      ...
      <AuthProvider>
        <Suspense>
          <Routes>
            ...
            <Route path="/blog" element={<ListBlogPage></ListBlogPage>}></Route>
